  ...
  return (
    <>
      ...
      <main className="min-h-screen text-white overflow-x-hidden" style={{ backgroundColor: '#0D1A2C' }}>
                  ...
                  <div className="p-8 md:p-10 flex flex-col justify-between h-full">
                    <div className="space-y-4">
                      ...
                      <p className="text-base leading-relaxed" style={{ color: '#9AB0B8' }}>
                        Advanced GPS and sensor fusion for accurate positioning and real-time path planning
                      </p>
                    </div>
                    <div className="mt-6">
                ...
                <SpotlightCard className="custom-spotlight-card min-h-[450px] hover:scale-[1.02] transition-transform duration-500 opacity-90 backdrop-blur-sm" spotlightColor="rgba(54, 82, 164, 0.2)">
                  <div className="p-8 md:p-10 flex flex-col justify-between h-full">
                    <div className="space-y-4">
                      ...
                      <p className="text-base leading-relaxed" style={{ color: '#9AB0B8' }}>
                        Real-time object detection and tracking capabilities with advanced AI algorithms
                      </p>
                    </div>
                    <div className="mt-6">
                      <div className="h-1.5 w-0 rounded-full group-hover:w-full transition-all duration-700 ease-out" style={{ background: 'linear-gradient(to right, #3652A4, #00824E)' }} />
                ...
                <SpotlightCard className="custom-spotlight-card min-h-[450px] hover:scale-[1.02] transition-transform duration-500 opacity-90 backdrop-blur-sm" spotlightColor="rgba(54, 82, 164, 0.2)">
                  <div className="p-8 md:p-10 flex flex-col justify-between h-full">
                    <div className="space-y-4">
                      ...
                      <p className="text-base leading-relaxed" style={{ color: '#9AB0B8' }}>
                        Intelligent decision-making and mission execution with adaptive learning systems
                      </p>
                    </div>
                    <div className="mt-6">
                      <div className="h-1.5 w-0 rounded-full group-hover:w-full transition-all duration-700 ease-out" style={{ background: 'linear-gradient(to right, #3652A4, #00824E)' }} />
        ...
        <section className="relative py-32 overflow-hidden" style={{ background: 'linear-gradient(to bottom, #0D1A2C, #1a2a3f)' }}>
          <div className="absolute inset-0">
