  ...
  return (
    <>
      ...
      <main className="bg-[#121212] text-white font-sans min-h-screen">
        ...
        <section className="py-20 px-6 md:px-10 border-b border-[#1e1e1e]">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Innovation in Motion</h1>
          <p className="text-lg md:text-xl text-white/75 max-w-4xl"> 
          Our team at NTU AAV is constantly pushing boundaries in UAV 
        ...
        <section className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="bg-[#181818] h-80 p-10 flex flex-col justify-between border-b border-r md:border-r border-[#1e1e1e]">
            ...
            <button 
             onClick =  { () => { router.push('/competitions/robotx-2026') } } 
             className="
             px-6 py-2
             bg-green-500
             text-white text-sm
          ...
          <div className="bg-[#181818] h-80 p-10 flex flex-col justify-between border-b border-[#1e1e1e]">
            ...
            <button 
             onClick =  { () => { router.push('/competitions/suas-2025') } } 
             className="
             px-6 py-2
             bg-green-500
             text-white text-sm
          ...
          <div className="bg-[#181818] h-80 p-10 flex flex-col justify-between border-b border-r md:border-r border-[#1e1e1e]">
            ...
            <button 
             onClick =  { () => { router.push('/sponsors') } } // later change to /sponsors/2026 once we have 2026 sponsors page setup
             className="
             px-6 py-2
             bg-green-500
             text-white text-sm
